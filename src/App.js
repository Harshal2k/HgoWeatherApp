...
async function getAddressData(coord, dispatch, setProgress) {
  ...
  try {
    ...
    var res = await fetch(`https://thingproxy.freeboard.io/fetch/http://a.positionstack.com/v1/reverse?access_key=${process.env.REACT_APP_POINTSTACK_API}&query=${lat},${lon}`);
    setProgress(40)
